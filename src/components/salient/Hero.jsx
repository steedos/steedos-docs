        ...
        Open-Source alternative to &nbsp;
         {'Salesforce'}
          <span className="relative whitespace-nowrap text-blue-600">
            ...
            <span className="relative">&nbsp;Low-Code</span>
          </span>&nbsp;{'Platform'}
  
        </h1>
        <p className="mt-6 text-lg text-slate-600 text-center max-w-3xl mx-auto dark:text-slate-400">
        Steedos offers deep customization and development capabilities beyond traditional no-code platforms. It not only allows users without a programming background to quickly create applications, but also provides experienced developers with powerful tools and frameworks for more complex customizations and integrations.
        </p>
        <div className="mt-10 flex justify-center gap-x-6">
          <a target="_blank" href="/getting-started/" className="group inline-flex items-center justify-center rounded-full py-2 px-4 text-sm font-semibold focus:outline-none focus-visible:outline-2 focus-visible:outline-offset-2 bg-slate-900 text-white hover:bg-slate-700 hover:text-slate-100 active:bg-slate-800 active:text-slate-300 focus-visible:outline-slate-900">
            Gettings Started
          </a>
          <Link target="_blank" to="/developer" className="group inline-flex ring-1 items-center justify-center rounded-full py-2 px-4 text-sm focus:outline-none ring-slate-200 text-slate-700 hover:text-slate-900 hover:ring-slate-300 active:bg-slate-100 active:text-slate-600 focus-visible:outline-blue-600 focus-visible:ring-slate-300">
            Developer Docs
          </Link>
        </div>
        <div className="relative max-w-3xl mx-auto px-4 sm:px-6 md:px-8 mt-10 ">
          <div className='w-[360px] h-[200px] sm:w-[640px] sm:h-[360px] mx-auto aspect-video'>
            <Player
              ...
              light={`https://console.steedos.cn/api/files/images/uYfiSbnj7Ms7djamt`}
              width="100%"
              height="100%"
            />
          </div>
    ...
    return (
      <Container className="pt-20 pb-16 text-center lg:pt-32">
        ...
        <div className="mt-10 flex justify-center gap-x-6">
          ...
          <Link target="_blank" to="/getting-started" className="group inline-flex ring-1 items-center justify-center rounded-full py-2 px-4 text-sm focus:outline-none ring-slate-200 text-slate-700 hover:text-slate-900 hover:ring-slate-300 active:bg-slate-100 active:text-slate-600 focus-visible:outline-blue-600 focus-visible:ring-slate-300">
            文档
          </Link>
        </div>
        <div className="relative max-w-3xl mx-auto px-4 sm:px-6 md:px-8 mt-10 ">
