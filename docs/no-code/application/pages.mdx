---
title: Micro Page Designer
sidebar_position: 20
---

The Micro Page Designer in the Steedos platform is a powerful interface that allows users to design and customize their application pages using a drag-and-drop approach.
...
After creating a Micro Page, you can open the Micro Page Designer to design the page:
