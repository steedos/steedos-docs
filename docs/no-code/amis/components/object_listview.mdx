...
This is a list view component based on the Huayan Magic Cube object, which displays object records as a table while including functionalities for CRUD and other operation buttons.
