...
The easiest way to deploy a local development environment is to use create-steedos-app. This CLI tool allows you to quickly start building a new HuanYan Magic Cube project and sets everything up for you.
