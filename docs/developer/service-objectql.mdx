...
- **参数**：
  ...
  - params: 
    ...
    - query: 查询数据相关参数[json]，选填。
      ...
      - filters: `SteedosQueryFilters` 查询条件数组。更多细节请参考[过滤条件规范](/docs/developer/filters)。
...
- **参数**：
  ...
  - params: 
    - objectName: `String` 对象的name。
    - query: 查询数据相关参数[json]。
      - filters: `Array`查询条件数组，选填。请参考[过滤条件规范](/docs/developer/filters)。
...
- **参数**：
  ...
  - params: 
    ...
    - query: 查询数据相关参数[json]，选填。
        ...
        - filters: `SteedosQueryFilters` 查询条件数组，选填。请参考[过滤条件规范](/docs/developer/filters)。
