...
All functions triggered before an event begin with the prefix "before".
...
All functions triggered after an event begin with the prefix "after".
...
size |	The total number of records in the trigger call (including old and new records).
