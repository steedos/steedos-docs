...
3. Create a signature: Go to "Signature Management" under "Domestic SMS" and create a signature. Follow the instructions and provide the required information. For example, create the signature "HuanYan Magic Cube". Once the signature is approved, you can see it in the signature management list.
